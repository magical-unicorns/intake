...
const seedUsers = () => {
    const users = [
        typeorm_1.createEntity(entities_1.User, {
...
const seedProject = (users) => typeorm_1.createEntity(entities_1.Project, {
    name: 'Project name',
...
const seedIssues = (project) => {
    const { users } = project;
    const issues = [
        typeorm_1.createEntity(entities_1.Issue, {
            title: 'Issue title 1',
...
const seedComments = (issue, user) => typeorm_1.createEntity(entities_1.Comment, {
    body: 'Comment body',
    issueId: issue.id,
    userId: user.id,
});
