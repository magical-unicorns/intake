...
exports.getProjectIssues = errors_1.catchErrors((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getIssueWithUsersAndComments = errors_1.catchErrors((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const issue = yield typeorm_1.findEntityOrThrow(entities_1.Issue, req.params.issueId, {
...
exports.create = errors_1.catchErrors((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const issue = yield typeorm_1.createEntity(entities_1.Issue, Object.assign(Object.assign({}, req.body), { listPosition }));
    res.respond({ issue });
}));
exports.update = errors_1.catchErrors((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const issue = yield typeorm_1.updateEntity(entities_1.Issue, req.params.issueId, req.body);
    res.respond({ issue });
}));
exports.remove = errors_1.catchErrors((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const issue = yield typeorm_1.deleteEntity(entities_1.Issue, req.params.issueId);
    res.respond({ issue });
}));
